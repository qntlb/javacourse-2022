 ...
 * of a triangle, so the general formula would of course ask us to sum the length of
 * the three sides. However, we maybe don't want to give the length of all the three
