...
public class Healing {
	...
	public static void someHealing(Cure c) {// object of any class implementing Cure
		 ...
		 * also not a use conform to Polymorphism
		 */
	...
	public static void main(String[] args) {
		 ...
		 * its class. Moreover, you are calling it from the same class where it is
		 * defined, so you don't even have to specify the name of the class.
		 */
