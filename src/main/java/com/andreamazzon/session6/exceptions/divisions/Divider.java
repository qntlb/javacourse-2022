 ...
 * reach a number smaller then minResult or bigger than maxResult. You save all
 ...
 *  Note: with ArrayList you can create an array without fixing its length (you avoid
...
public class Divider {
	...
	/**
	 * It start by dividing a firstDividend by a divisor. If divisor is zero, it throws an exception.
	 ...
	 * @param maxResult, the minimum result we want to get 
	...
	public static void divide(double firstDividend, double divisor, double minResult, double maxResult)
		...
		while (result > minResult & result < maxResult) {// a way to say that it continues indefinitely (true always true)
