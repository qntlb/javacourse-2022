...
/**
 * This class contains a private int field, which is accessed by its inner
 * class. The inner class has also a private int field, which can be accessed by
 * the outer class after producing an object of the inner class.
 *
