...
public class StreamsExample {
	...
	public static void main(String[] args) {
		...
		Double[] arrayToBeFilled = new Double[length];
		...
		System.out.println(firstStream.collect(Collectors.toList()));
		 ...
		 */
		System.out.println(secondStream.anyMatch(number -> number > 250));

		Stream<Double> thirdStream = streamSupplier.get();
		
		/*
		 * How to check if it is true or not that all the elements of a Stream
		 * satisfy one property
		 */
		System.out.println(thirdStream.allMatch(number -> number > 250));
		...
		System.out.println(fourthStream.collect(Collectors.toList()));
		...
		System.out.println(sixthStream.collect(Collectors.toList()));
