 ...
 * which provides the implementation of some methods that can be called to 
 ...
 * have a field that is an object of a class that generate pseudo random
 * integers, and which is used in the implementation of generateRealizations().
 */
