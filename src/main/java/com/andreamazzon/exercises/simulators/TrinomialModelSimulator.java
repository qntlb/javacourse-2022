package com.andreamazzon.exercises.simulators;
 ...
 * where r is the risk free interest rate. This serves as an example of composition
 * combined to inheritance: the class has an object of type LinearCongruentialGenerator,
 * which is used to generate the realizations M(i), and inherits from the abstract class
