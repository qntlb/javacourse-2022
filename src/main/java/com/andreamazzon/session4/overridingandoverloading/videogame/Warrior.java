...
/**
 * This class will be extended by MorePowerfulWarrior. It has three methods,
 * damage(Warrior warrior) and move(double x, double y). Note that the method
 * damage(Warrior warrior) will be overridden (because more damages and caused)
 * and also overloaded. All the other methods will be just inherited.
 *
