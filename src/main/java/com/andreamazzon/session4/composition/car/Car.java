 ...
 * Car, and you want to use the only method of the class Engine. Thinking in
 * this way, you might think to use inheritance. However, inheritance usually
 * expresses a relation of the type "DerivedClass is a type of BaseClass",
 ...
 * a field of type Engine, which implements a method start(). Car also has a
 * method start() which uses an object of type Engine and ask it (delegates it)
 * to call the engine() method of Engine. Car is in fact DELEGATING to Engine
