 ...
 * under the risk neutral measure: it can be seen that it must hold p=(1 + r -
 * d)/(u - d), where r is the risk free interest rate. This is also an example
 * of composition, because the class has a field of type BinomialModelSimulator
...
public class BinomialModelUser {
	...
	private void generateRealizations() {
		//generated only once: look at getRealizations() in BinomialModelSimulator
